...
||회원상세페이지|
|------|---|
|설명|-정보를 알고 싶은 유저를 클릭하면 해당하는 회원 상세페이지가 보여지도록 구현 <br> -회원 고유의 아이디 값을 받아와서 각각 회원에 따라 다른 회원정보가 보여질 수 있도록 함<br> -작성한 레시피와 작성한 후기 두가지의 탭으로 나눠 각각의 엔드포인트에 따라 적정 데이터를 받아올 수 있도록함<br>|
